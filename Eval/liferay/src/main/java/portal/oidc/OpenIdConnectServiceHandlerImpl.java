...
import portal.oidc.api.*;
/*import portal.oidc.api.constants.OpenIdConnectConstants;
import portal.oidc.api.constants.OpenIdConnectWebKeys;*/
...
public class OpenIdConnectServiceHandlerImpl
    ...
    public void processAuthenticationResponse(
        ...
        try {
            ...
            OpenIdConnectProvider<OIDCClientMetadata, OIDCProviderMetadata>
                    openIdConnectProvider = ( OpenIdConnectProvider<OIDCClientMetadata, OIDCProviderMetadata>) dummy.get("providerdummy");
               //     _openIdConnectProviderRegistry.findOpenIdConnectProvider(openIdConnectSessionImpl.getOpenIdProviderName());
    ...
    public void requestAuthentication(
            ...
            HttpServletRequest httpServletRequest,
            HttpServletResponse httpServletResponse)
            /*throws PortalException*/ throws SecurityException {

        OpenIdConnectProvider<OIDCClientMetadata, OIDCProviderMetadata>
                openIdConnectProvider = ( OpenIdConnectProvider<OIDCClientMetadata, OIDCProviderMetadata>) dummy.get("provider");
    ...
    protected OpenIdConnectSessionImpl createAndSetOpenIdConnectSession(
        ...
        httpSession.setAttribute(
                "key",// OpenIdConnectWebKeys.OPEN_ID_CONNECT_SESSION,
    ...
    protected AuthenticationSuccessResponse getAuthenticationSuccessResponse(
        ...
        if (/*Validator.isNotNull(*/!httpServletRequest.getQueryString().isEmpty()) {
    ...
    protected URI getLoginRedirectURI(HttpServletRequest httpServletRequest) {
        try {
            ...
            sb.append("some/url"); // _portal.getPortalURL(httpServletRequest)
    ...
    protected OpenIdConnectSessionImpl getOpenIdConnectSessionImpl(
        ...
        if (openIdConnectSessionObject instanceof OpenIdConnectSessionImpl) {
            ...
            if (/*Validator.isNull(*/ expectedProviderName == null ||
    ...
    protected void processUserInfo(
        ...
        long userId = 1000L;//_openIdConnectUserInfoProcessor.processUserInfo( userInfo, companyId);
