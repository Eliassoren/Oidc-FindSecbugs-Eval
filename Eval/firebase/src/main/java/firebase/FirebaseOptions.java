...
public final class FirebaseOptions {
  ...
  private FirebaseOptions(@NonNull final FirebaseOptions.Builder builder) {
    ...
    this.credentialsSupplier = checkNotNull(
        builder.credentialsSupplier, "firebase.FirebaseOptions must be initialized with setCredentials().");
    ...
    this.httpTransport = checkNotNull(builder.httpTransport,
        "firebase.FirebaseOptions must be initialized with a non-null HttpTransport.");
    this.jsonFactory = checkNotNull(builder.jsonFactory,
        "firebase.FirebaseOptions must be initialized with a non-null JsonFactory.");
    this.threadManager = checkNotNull(builder.threadManager,
        "firebase.FirebaseOptions must be initialized with a non-null firebase.ThreadManager.");
  ...
  public static final class Builder {
    ...
    /**
     * Sets the <code>firebase.ThreadManager</code> used to initialize thread pools and thread factories
     * for Firebase apps.
     *
     * @param threadManager A <code>firebase.ThreadManager</code> instance.
     * @return This <code>Builder</code> instance is returned so subsequent calls can be chained.
     */
