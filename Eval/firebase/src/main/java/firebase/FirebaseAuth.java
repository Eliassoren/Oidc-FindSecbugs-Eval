 ...
 * creating new firebase.FirebaseApp instances that are scoped to a particular authentication UID.
 */
public class FirebaseAuth {
  ...
  /**
   * Gets the firebase.FirebaseAuth instance for the default {@link FirebaseApp}.
   *
   * @return The firebase.FirebaseAuth instance for the default {@link FirebaseApp}.
   */
  ...
  /**
   * Gets an instance of firebase.FirebaseAuth for a specific {@link FirebaseApp}.
   *
   * @param app The {@link FirebaseApp} to get a firebase.FirebaseAuth instance for.
   * @return A firebase.FirebaseAuth instance.
   */
   ...
   * @return An {@code firebase.ApiFuture} which will complete successfully with the parsed token, or
  ...
  private void checkNotDestroyed() {
    synchronized (lock) {
      checkState(!destroyed.get(), "firebase.FirebaseAuth instance is no longer alive. This happens when "
          + "the parent firebase.FirebaseApp instance has been deleted.");
    }
  }
