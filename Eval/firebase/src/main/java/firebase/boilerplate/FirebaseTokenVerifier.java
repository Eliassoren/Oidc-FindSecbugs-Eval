...
public interface FirebaseTokenVerifier {
   ...
   * @throws ExportedUserRecord.FirebaseAuthException If the input token string fails to verify due to any reason.
   */
  FirebaseToken verifyToken(String token) throws ExportedUserRecord.FirebaseAuthException;
