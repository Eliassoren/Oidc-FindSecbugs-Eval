...
public class UserRecord implements UserInfo {
  ...
  /**
   * Returns an array of {@code firebase.boilerplate.UserInfo} objects that represents the identities from different
   ...
   *
   * @return a non-null firebase.boilerplate.UserMetadata instance.
   */
   ...
   * of this user.
   *
   * @return a non-null firebase    UserRecord.UpdateRequest instance.
   */
