...
import firebase.internal.FirebaseThreadManagers;
...
public final class FirebaseOptions {
  ...
  private FirebaseOptions(@NonNull final FirebaseOptions.Builder builder) {
    ...
    this.credentialsSupplier = checkNotNull(
        builder.credentialsSupplier, "firebase.boilerplate.FirebaseOptions must be initialized with setCredentials().");
    ...
    this.httpTransport = checkNotNull(builder.httpTransport,
        "firebase.boilerplate.FirebaseOptions must be initialized with a non-null HttpTransport.");
    this.jsonFactory = checkNotNull(builder.jsonFactory,
        "firebase.boilerplate.FirebaseOptions must be initialized with a non-null JsonFactory.");
    this.threadManager = checkNotNull(builder.threadManager,
        "firebase.boilerplate.FirebaseOptions must be initialized with a non-null firebase.boilerplate.ThreadManager.");
  ...
  public static final class Builder {
    ...
    /**
     * Sets the <code>firebase.boilerplate.ThreadManager</code> used to initialize thread pools and thread factories
     * for Firebase apps.
     *
     * @param threadManager A <code>firebase.boilerplate.ThreadManager</code> instance.
     * @return This <code>Builder</code> instance is returned so subsequent calls can be chained.
     */
